...
from .views import PostList, PostView, UserView, PostAdd, PostEdit, PostDelete, comment_add, comment_commit, comment_delete
...
urlpatterns = [
    ...
    path('<int:pk>/commit', comment_commit, name='commit'),
    path('<int:pk>/delete', comment_delete, name='delete_comment')
    ]
